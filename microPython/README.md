...
To use the library, first download it to ESP32, then open the routines folder.  To execute a routine read_temp.py, type Python read_temp.py on the command line.  
